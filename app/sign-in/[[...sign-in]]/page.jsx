      ...
      <div className="hidden md:flex md:w-1/2 items-center justify-center p-4 md:p-8">
        <div className="relative">
          ...
          <div className="relative bg-black/20 backdrop-blur-xl rounded-lg p-8">
            <h2 className="text-3xl font-bold text-white mb-4">Welcome to BookCraft AI</h2>
            <p className="text-gray-300">Create and explore amazing books with the power of AI</p>
      ...
      <div className="w-full md:w-1/2 flex items-center justify-center p-4 min-h-screen md:min-h-0">
        <div className="w-full max-w-md px-4 md:px-0">
          <div className="mb-6 md:mb-8 text-center">
            ...
            <p className="text-gray-400 text-sm md:text-base">Sign in to continue your journey with BookCraft AI</p>
          </div>
          <SignIn
            appearance={{
              elements: {
                ...
                footerActionText: "!text-gray-400 !bg-transparent",
                ...
                formFooterText: "text-gray-400",
                otherLoginText: "text-gray-400",
                alternativeMethodsBlockButton: "text-white",
                formFieldSuccess: "text-green-400",
                logoImage: "mx-auto",
                navbar: "bg-transparent",
                navbarButtons: "bg-transparent",
                navbarButtonText: "text-gray-400",
                navbarButton: "bg-transparent",
                socialButtonsIconButton: "bg-white/10 hover:bg-white/20",
                socialButtonsProviderIcon: "h-5 w-5 text-white",
                main: "!bg-transparent [&>*]:!bg-transparent",
                form: "!bg-transparent",
                internal: {
